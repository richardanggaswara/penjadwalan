   ...
   <div  class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo site_url();?>/adminmapel/logout"><span>Penjadwalan</span></a>
				<div class="btn-group pull-right" >
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo site_url();?>/adminmapel/logout">Logout</a></li>
					</ul>
				</div>
				<!-- user dropdown ends -->
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="#">Data Mata Pelajaran</a> <span class="divider">/</span>
					</li>
					<li>
						<a href="#">Input/Edit/Delete</a>
					</li>
				</ul>
			</div><?php $this->load->view('adminmapel_view');?>		

			<div style="padding-top:20px;">

						<?php echo validation_errors('<p class="error" style="font-size:16px;color:red">'); ?>
							<?php echo form_open('adminmapel/insert'); ?>
														<h2>Input Data Mata Pelajaran</h2>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="kode_mapel" style="font-size:18px;"><b>Kode Mata Pelajaran</b></label>
  <div class="controls">
    <input id="kode_mapel" name="kode_mapel" type="text" placeholder="kode mapel" class="input-xlarge" required="">
    <p class="help-block">Masukkan nama kode mata pelajaran</p>
  </div>
</div>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="mapel" style="font-size:18px;"><b>Mata Pelajaran</b></label>
  <div class="controls">
    <input id="mapel" name="mapel" type="text" placeholder="mapel" class="input-xlarge" required="">
    <p class="help-block">Masukkan nama mata pelajaran </p>
  </div>
</div>
<hr></hr>
<div class="control-group">

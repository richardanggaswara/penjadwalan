	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="#">Data Ruangan</a> <span class="divider">/</span>
					</li>
					<li>
						<a href="#">Input/Delete</a>
					</li>
				</ul>
			</div><?php $this->load->view('adminruang_view');?>		

			<div style="padding-top:20px;">

						<?php echo validation_errors('<p class="error" style="font-size:16px;color:red">'); ?>
							<?php echo form_open('adminruang/insert'); ?>
														<h2>Input Data Ruang</h2>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="idRuang" style="font-size:18px;"><b>Nama Ruang</b></label>
  <div class="controls">
    <input id="idRuang" name="idRuang" type="text" placeholder="nama ruang" class="input-xlarge" required="">
    <p class="help-block">Masukkan nama ruangan</p>
  </div>
</div>
<hr></hr>
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="KapasitasRuang" name="KapasitasRuang" type="text" placeholder="kapasitas ruang" class="input-xlarge" required="">
    <p class="help-block">Kapasitas ruangan</p>
  </div>
</div>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="guru_id" style="font-size:18px;"><b>Wali Kelas / Staff Bertanggungjawab</b></label>
  <div class="controls">
...
<div class="control-group">
  ...
  <div class="controls">
    <select id="DeskripsiRuang" name="DeskripsiRuang">

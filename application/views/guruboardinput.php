...
<div id="main_container">
 ...
 echo "</td></tr><tr><td></table>";?>
    ...
    <div id="main_content" style="margin:5px;">
       <h2 style="width:75%">Assign Jadwal</h2>
	   <table style="background-color:#CFFBFF;">
	   <?php 
		echo "<div style='margin-bottom:10px;'>";
		echo form_open('gurudashboard/inputbykelas',array('id'=>'autosubmit'));
		echo "&nbsp;&nbsp;";
		echo "<text style='color:#59CEF9;font-size:12px;'>Pilih Kelas</text>";
		echo "&nbsp;&nbsp;";
		echo form_dropdown('no',$retrieveharibykuota,array(),'style="width:150px"')."\n";
		echo "&nbsp;";
		echo "&nbsp;&nbsp;&nbsp;";
        ...
        echo "<ul class='dateul'>\n"; 
			...
			echo "<p>Kode : ",$retrievematpel, " / " , anchor("gurudashboard/unbook/".$displayjam['jam_ke']."/".$no."/".$displayjam['hari_id'],'Unbook');
			}else{
			echo "<p>Kode : ", anchor("gurudashboard/booking/".$displayjam['jam_ke']."/".$no."/".$displayjam['hari_id'],'Booking');	
			}
			echo "</li>";
    echo "</ul>";
	echo "</li>";

	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="#">Data Guru</a> <span class="divider">/</span>
					</li>
					<li>
						<a href="#">Input/Delete</a>
					</li>
				</ul>
			</div><?php $this->load->view('adminguru_view');?>		

			<div style="padding-top:20px;">

						<?php echo validation_errors('<p class="error" style="font-size:16px;color:red">'); ?>
							<?php echo form_open('adminguru/insert'); ?>
														<h2>Input Data Guru</h2>
														<hr></hr>
<div class="control-group">
  <label class="control-label" for="guru_nama" style="font-size:18px;"><b>NIK Guru</b></label>
  <div class="controls">
    <input id="guru_nik" name="guru_nik" type="text" placeholder="nama guru" class="input-xlarge" required="">
    <p class="help-block">Masukkan No Induk Kepegawaian Guru yang mengajar</p>
  </div>
</div>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="guru_nama" style="font-size:18px;"><b>Nama Guru</b></label>
  <div class="controls">
    <input id="guru_nama" name="guru_nama" type="text" placeholder="nama guru" class="input-xlarge" required="">
    <p class="help-block">Masukkan nama guru yang mengajar</p>
  </div>
</div>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="guru_alamat" style="font-size:18px;"><b>Alamat Guru</b></label>
  <div class="controls">
    <input id="guru_alamat" name="guru_alamat" type="text" placeholder="alamat guru" class="input-xlarge" required="">
    <p class="help-block">Masukkan alamat Guru yang bersangkutan</p>
  </div>
</div>
<hr></hr>
<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="guru_status" style="font-size:18px;"><b>Status Guru</b></label>
  <div class="controls">
    <select id="guru_status" name="guru_status" class="input-xlarge" required="">
		<option>Sudah Menikah</option>
		<option>Belum Menikah</option>
	</select>
    <p class="help-block">Masukkan status Guru yang bersangkutan</p>
  </div>
</div>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="guru_nohp" style="font-size:18px;"><b>Kontak Guru</b></label>
  <div class="controls">
    <input id="guru_nohp" name="guru_nohp" type="text" placeholder="kontak guru" class="input-xlarge" required="">
    <p class="help-block">Masukkan kontak Guru yang bersangkutan</p>
	<?php echo form_error('guru_nohp'); ?>
  </div>
</div>
<hr></hr>
<div class="control-group">
  <label class="control-label" for="guru_jabatan" style="font-size:18px;"><b>Deskripsi Kerja Guru</b></label>
  <div class="controls">
    <select id="guru_status" name="guru_jabatan" class="input-xlarge" required="">
		<option>Pengajar Tetap</option>
		<option>Pengajar Bantuan</option>
	</select>
    <p class="help-block">Masukkan deskripsi kerja Guru yang bersangkutan</p>
  </div>
</div>
<hr></hr>
<!-- Button -->

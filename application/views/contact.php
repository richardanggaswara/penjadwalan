...
Kurikulum pengganti KTSP, yaitu kurikulum 2013 mulai diterapkan tahun pelajaran 2013/2014 pada tingkat SD sampai dengan SMA/SMK. 
  ...
  <h2>Isi kolom untuk menghubungi</h2>
                 <div id="contact_form">
                    <div class="form_row">
                    <label>Nama:</label><input type="text" name="name" class="contact_input" />
                    </div>
                    ...
                    <label>Email:</label><input type="text" name="email" class="contact_input" />
                     ...
                     <div class="form_row">
                    <label>Telepon:</label><input type="text" name="phone" class="contact_input" />
                    </div>                   
                    
                    <div class="form_row">
                    <label>Pesan:</label><textarea name="name" class="contact_textarea"></textarea>
                    </div> 
                    
                    
					<div class="send"><a href="#">Kirim</a></div>               

...
Kurikulum pengganti KTSP, yaitu kurikulum 2013 mulai diterapkan tahun pelajaran 2013/2014 pada tingkat SD sampai dengan SMA/SMK. 
  ...
  <h2>Masukkan Username dan Password Guru</h2>
                 <div id="contact_form">
				 <?php echo form_open('verifylogin') ?>
                    <div class="form_row">
                    <label style="color:black">Username:</label><input type="text" name="name" id="name" class="contact_input" />
                    </div>     
                    <div class="form_row">
                    <label style="color:black">Password:</label><input type="password" name="password" id="password" class="contact_input" />
                    </div>                                   
					<input id="btnlogin" class="send" value="Login" type="submit" style="color:black;font-weight:bold;"/>                
                </div>

...
Class ClientClass3 extends CI_Controller {
	...
	public function index(){
		...
		$data['dropdownkelas'] = $this->Jadwal->getdropkelasix();
		if($this->input->post('no') and $this->input->post('hari_id')){
			...
			$firstkelas = $this->Jadwal->getfirstkelasix();
		...
		$this->load->view('homeclass1_3',$data);
	}
}
?>